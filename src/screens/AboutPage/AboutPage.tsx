...
export const AboutPage = (): JSX.Element => {
  ...
  const aboutStructuredData = {
    ...
    "@type": "AboutPage",
    "name": "About Rentwala - Leading Real Estate Company in India",
    "description": "Learn about Rentwala's 12+ years of experience in Indian real estate. Our mission, values, and expert team helping clients find their dream properties.",
    "url": "https://rentwala.com/about",
    "mainEntity": {
  ...
  return (
    <>
      <SEOHead
        title="About Rentwala - Leading Real Estate Company in India | 12+ Years Experience"
        description="Learn about Rentwala's journey as India's leading real estate platform. 12+ years of experience, 25,000+ properties sold, and 15,000+ happy clients across Delhi-NCR."
        keywords="about Rentwala, real estate company India, property experts Delhi, real estate agents NCR, property consultants Gurgaon, real estate experience India"
        url="https://rentwala.com/about"
        canonical="https://rentwala.com/about"
